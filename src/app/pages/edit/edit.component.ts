...
export class EditComponent implements OnInit{
  ...
  auxButtonSelector(auxButton: string){
    // ya no tiene utilidad y siquiera es llamado... pero si se quita sale error. ¿como remover?
    //console.log("parámetro recibido: ", auxButton);
  }
